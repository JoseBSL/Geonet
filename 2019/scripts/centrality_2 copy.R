...
cent2$Latitude <- abs(cent2$Latitude)
...
#latitude
cent.brm3 <- brm(n.closeness~PolOrder*Latitude+(1|Reference/Network),
                 family=zero_one_inflated_beta(),cores=4,
                 seed=123,
                 prior=cent_priors,
                 data=cent2)

betw.brm3 <- brm(betweenness~PolOrder*Latitude+(1|Reference/Network),
                 family=zero_inflated_beta(),cores=4,
                 seed=123,
                 prior=cent_priors,
                 data=cent2)

betw.brm4 <- brm(betweenness~PolOrder*Latitude+(1|Reference/Network),
                 family=zero_one_inflated_beta(),cores=4,
                 seed=123,
                 prior=cent_priors,
                 data=cent2)
...
#lat models
cent.brm3 <- add_criterion(cent.brm3,criterion = c("waic","loo"))
betw.brm3 <- add_criterion(betw.brm3,criterion = c("waic","loo"))
betw.brm4 <- add_criterion(betw.brm4,criterion = c("waic","loo"))
...
cent.gg=ggplot(rbind.cent.plot,aes(x=`Pollinator taxa`,y=estimate__,col=`Pollinator taxa`))+
  ...
  scale_color_manual(breaks=list_spp.2,
                     values=plot_cols.2,
